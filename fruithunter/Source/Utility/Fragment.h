...
class Fragment {
public:
	enum Type { entity, animal, terrain, particleSystem, sea, totemLock, size };
	std::string m_typeAsString[Type::size] = { "Entity", "Animal", "Terrain", "ParticleSystem", "Sea", "TotemLock" };
